...
class RuntimeEnv implements EnvironmentDetails {
    ...
    public RuntimeEnv(String file) {
        ...
        if(!getInputData() != null){
            ...
            def result = slurper.parseText(getInputData())
             def inputkeyset  = result.input.keySet()
            println("===================================================================================")
            inputkeyset.each {
                print(" Input Params : ${it}"  + " -- value -- " )
                println(result.input."$it" + " ||")
                properties.setProperty("$it",result.input."$it")
            }
            println("===================================================================================")
        }
    }
    ...
    String getServiceTypePOD(){
        return properties.serviceTypePOD
    }
    String getPODName(){
        return properties.PODName
    }
    String getNotificationEmail(){
        return properties.NotificationEmail
    }
    String getPsmRestApiEndPointforLog(){
        return properties.PsmRestApiEndPointforLog
    }

    String getloadBalancerSubnet1(){
        return properties.loadBalancerSubnet1
    }

    String getloadBalancerSubnet2(){
        return properties.loadBalancerSubnet2
    }

    String getserviceSubnet(){
        return properties.serviceSubnet
    }

    String getdbaasSubnet(){
        return properties.dbaasSubnet
    }
    ...
    String getavailabilityDomain(){
        return properties.availabilityDomain
    }
    ...
    String getIDCSAPIforApplication(){
        return properties.IDCSAPIforApplication
    }
    String getStackTemplate(){
        return properties.StackTemplate
    }


    String getInputData(){
        return System.getProperty("inputdata")
    }

    String getGenericData(String keyname){
        if(properties.getProperty("$keyname") == null){
            Assert.fail("INPUT-ERROR:: >>>>>>>> : Missing Input Value for :" + keyname)
        }
